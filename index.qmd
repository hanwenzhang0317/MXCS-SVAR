...
```{r}
GetPrior.parameters <- function (N,p,Sigma.hat,nu.kappa,S.kappa) {
...
```{r}
#| echo: true
GetPosterior.parameters <- function (X,Y,A.prior,nu.prior,S.prior,V.prior) {
...
prior.parameters <- GetPrior.parameters(N,p,Sigma.hat,nu.kappa,S.kappa)
...
poesterior.parameters.iw <- GetPosterior.parameters(X,Y,A.prior,nu.prior,S.prior,V.prior)
...
prior.e <- GetPrior.parameters(N,p,Sigma.hat,nu.kappa,S.kappa)
...
S2 = 45000
posterior.e <-
DrawPosterior.e(Y,X,nu.prior,A.prior,V.prior,S.prior,nu.kappa,S.kappa,S1,S2)
